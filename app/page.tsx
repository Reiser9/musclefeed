                    ...
                    <div className={styles.mainWrapper}>
                        <div className={styles.mainInner}>
                            ...
                            <div className={styles.mainContent}>
                                <h1 className={styles.mainTitleInner}>
                                    <span className={styles.mainTitle}>готовые</span>
                                    <span className={cn(styles.mainTitle, styles.green)}>сбалансированные рационы</span>
                                    <span className={styles.mainTitle}>на каждый день</span>
                                </h1>
                                ...
                                <div className={styles.mainTextInner}>
                                    ...
                                    <p className={styles.mainSubtext}>Добиваться целей - легко, с Muscle Feed!</p>
                                </div>
                                ...
                                <p className={styles.mainDelivery}>с доставкой на дом</p>
                            </div>
                        </div>
                        ...
                        <div className={styles.mainPoints}>
                            <div className={styles.mainPoint}>
                                ...
                                <p className={styles.mapPointText}>Доставка раз в два дня вечером</p>
                            </div>

                            <div className={styles.mainPoint}>
                                <div className={styles.mapPointIcon}>
                                    <img src="img/map5.svg" alt="icon" />
                                </div>

                                <p className={styles.mapPointText}>Гарантируем вкус и качество</p>
                            </div>
                            ...
                            <div className={styles.mainPoint}>
                                ...
                                <p className={styles.mapPointText}>Свежая еда на каждые два дня</p>
                            </div>
                            ...
                            <div className={styles.mainPoint}>
                                ...
                                <p className={styles.mapPointText}>Предоставляем возможности для замены блюд</p>
                            </div>
                ...
                <div className={base.container}>
                    <div className={styles.complexInner}>
                        ...
                        <div className={styles.complexSlider}>
                            <div className={cn(styles.complexItem, styles.active)}>
                                <div className={styles.complexTextInner}>
                                    <p className={styles.complexTextTitle}>Баланс</p>

                                    <p className={styles.complexTextText}>
                                        Готовые решения для похудения, набора массы или просто правильного питания.
                                    </p>

                                    <p className={styles.complexTextPrice}>от 799 ₪</p>
                                </div>

                                <img src="img/complex1.png" alt="complex" className={styles.complexItemImg} />
                            </div>

                            <a href="racion.html" className={cn(styles.complexItem, styles.yellow)}>
                                <div className={styles.complexTextInner}>
                                    <p className={styles.complexTextTitle}>Комбо</p>

                                    <p className={styles.complexTextText}>
                                        Не хотите тратить время на готовку? Выбирайте наши комбо-наборы — быстро, вкусно
                                        и полезно
                                    </p>

                                    <p className={styles.complexTextPrice}>от 1 799 ₪</p>
                                </div>

                                <img src="img/complex2.png" alt="complex" className={styles.complexItemImg} />
                            </a>

                            <div className={cn(styles.complexItem, styles.green)}>
                                <div className={styles.complexTextInner}>
                                    <p className={styles.complexTextTitle}>На выбор</p>

                                    <p className={styles.complexTextText}>
                                        Выберите любые блюда на свой вкус из нашего меню и составьте свой идеальный
                                        заказ. Минимальная сумма заказа — 200 шекелей
                                    </p>

                                    <p className={styles.complexTextPrice}>от 200 ₪</p>
                                </div>

                                <img src="img/complex3.png" alt="complex" className={styles.complexItemImg} />
                            </div>
                        </div>
                        ...
                        <div className={cn(styles.complexWrp, styles.active)}>
                            <div className={styles.foodTextInner}>
                                <p className={styles.foodTextTitle}>
                                    Сбалансированные программы питания на каждый день
                                </p>

                                <p className={styles.foodTextText}>
                                    Для тех, кто ценит своё время и здоровье: готовые решения для похудения, набора
                                    массы или просто правильного питания. Мы продумали всё, чтобы вы могли наслаждаться
                                    и достигать своих целей. Наши программы разработаны с учетом индивидуальных
                                    потребностей, чтобы каждый мог найти подходящий вариант. Присоединяйтесь к нам и
                            ...
                            <div className={styles.foodForm}>
                                <div className={styles.foodFormItem}>
                                    ...
                                    <div className={styles.foodFormItemContent}>
                                        <button
                                            className={cn(styles.foodFormChoose, styles.foodCalories, styles.active)}
                                        >
                                            750 ккал
                                ...
                                <div className={styles.foodFormItem}>
                                    ...
                                    <div className={styles.foodFormItemContent}>
                                        ...
                                        <button className={styles.foodFormChoose}>
                                            Неделя
                                            <span className={cn(styles.food__sale, styles.block)}>3 дня в подарок</span>
                                        </button>
                            ...
                            <div className={styles.foodMenu}>
                                {/* <div className="food__menu--item">
                                    ...
                                    <div className="food__item--text--inner">
                                        ...
                                        <p className="food__item--price">799 ₽</p>

                                        <button className="button food__item--button addto__cart">
                                            ...
                                            <span className="added__content">
                                                <span className="added__content--button food__minus">
                                                    <Minus />
                                                </span>

                                                <span className="food__count">1</span>

                                                <span className={cn(styles.addedContentButton, styles.foodPlus)}>
                                                    <Plus />
                                                </span>
                                            </span>
                                        </button>
            ...
            {/* <section className="cart">
                <div className="container">
                    <div className="cart__inner">
                        <div className="cart__title--inner">
                            <p className="cart__title">Cкидка! не упускай возможность</p>
                        ...
                        <div className="cart__price--inner">
                            <div className="cart__price--wrap">
                                <p className="cart__price--old">345 ₪</p>

                                <p className="cart__price">Итого: 145 ₪ / день</p>
                            </div>

                            <button className="button cart__button modal__show" data-modal="order__cart">
                                Оформить заказ за 2 345 ₪
                                <svg
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                ...
                <div className={base.container}>
                    <div className={styles.reviewsInner}>
                        <div className={styles.reviewsTitleInner}>
                            ...
                            <Button href="/reviews" color="green">
                                Смотреть все отзывы
                                <ArrowRight />
                            </Button>
                        </div>
